...
def make(
    ...
    if not env_id in gymnasium.envs.registration.registry:
        task_kwargs = {}
        if seed is not None:
        ...
        register(
            id=env_id,
            entry_point='dmc_envs.dmc2gym:DistractionDMCWrapper' if disctracting_control else 'dmc_envs.dmc2gym:DMCWrapper',
            kwargs=dict(
